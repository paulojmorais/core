...
const sources = {
    ...
    generic: [
        ...
        './src/main/generic/network/address/SignalRoute.js',
        './src/main/generic/network/address/PeerAddressState.js',
        './src/main/generic/network/address/PeerAddressBook.js',
        './src/main/generic/network/address/PeerAddressPicker.js',
        './src/main/generic/network/address/PeerAddressOperator.js',
